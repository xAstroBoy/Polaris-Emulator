...
public class AddFloorItemComposer extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        // serializeItemData, not upstream's serializeExtradata: this fork's custom colours and tile
        // shape ride along with the extradata. The expiry below is upstream's rentables.
