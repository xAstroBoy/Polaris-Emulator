...
public class Incoming {
    ...
    // Upstream claimed 7020/7021 for the paint removal, so the custom name colour moved up to 7022.
    // OutgoingHeader.SET_NAME_COLOR in the renderer has to stay on the same number.
    public static final int SetNameColorEvent = 7022; // CUSTOM
