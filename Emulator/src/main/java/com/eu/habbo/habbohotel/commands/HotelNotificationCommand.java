...
import com.eu.habbo.messages.outgoing.generic.alerts.NotificationDialogComposer;
...
public class HotelNotificationCommand extends Command {
    ...
    static void send(Habbo sender, Room room, String type, String extra) {
        ...
        NotificationDialogComposer composer = new NotificationDialogComposer("hotel.notifica." + type, parameters);
