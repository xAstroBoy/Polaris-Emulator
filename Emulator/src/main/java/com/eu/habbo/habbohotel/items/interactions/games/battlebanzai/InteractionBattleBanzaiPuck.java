...
public class InteractionBattleBanzaiPuck extends InteractionPushable {
    ...
    public InteractionBattleBanzaiPuck(
    ...
    public boolean validMove(Room room, RoomTile from, RoomTile to) {
        ...
        // return !(!room.getLayout().tileWalkable(to.x, to.y) || (topItem != null &&
        // (!topItem.getBaseItem().setAllowStack() || topItem.getBaseItem().allowSit() ||
        // topItem.getBaseItem().allowLay())));
    }
