...
public class InteractionFXBox extends InteractionDefault {
    ...
    public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
        if (client != null
                && this.getUserId() == client.getHabbo().getHabboInfo().getId()) {
            if (this.getExtradata().equals("1")) return;
            ...
            if (client.getHabbo().getInventory().getEffectsComponent().ownsEffect(effectId)) return;
